...
public class BookListApp {
	...
	public static void main(String[] args) {
		...
		while (choice.equalsIgnoreCase("y")) {
			...
			String category = Console
					.getRequiredString("What category are you interested in? (Adventure, Romance or Horror?)");
			System.out.println();
			...
			int input = sc.nextInt();// scan for number associated with book
										// name
			sc.nextLine();
